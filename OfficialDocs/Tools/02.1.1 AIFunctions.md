...
When a plugin has multiple functions, you can group them under a collapsible container using `[Collapse]`:
...
Plugins can receive services through constructor injection:
...
public class WeatherPlugin
{
    ...
    public WeatherPlugin(IWeatherService weatherService, ILogger<WeatherPlugin> logger)
    {
...
→ See [02.1.4 Plugin Metadata.md](02.1.4%20Plugin%20Metadata.md) for details on metadata and dynamic descriptions.
