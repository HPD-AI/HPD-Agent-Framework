...
When a tool has multiple functions, you can group them under a collapsible container using `[Collapse]`:
...
→ See [02.1.4 Tool Metadata.md](02.1.4%20Tool%20Metadata.md) for details on metadata and dynamic descriptions.
...
→ See [02.1.4 Tool Metadata.md](02.1.4%20Tool%20Metadata.md) for conditional registration details.
...
6. **Group related functions**: Use `[Collapse]` to reduce context clutter.
