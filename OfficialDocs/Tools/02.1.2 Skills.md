...
## Skills vs Collapsed Tools

Both skills and collapsed tools group functions, but they serve different purposes:

| Aspect | Skill | Collapsed Tool |
|--------|-------|------------------|
...
| **Scope** | Can reference functions across tools | Single tool only |
