...
→ See [02.1.4 Tool Metadata.md](02.1.4%20Tool%20Metadata.md) for details.
...
When you have many tools, the agent's context window can become cluttered. HPD-Agent supports **collapsing** plugins into containers that expand on demand.
...
- [02.1.4 Tool Metadata.md](02.1.4%20Tool%20Metadata.md) - Dynamic descriptions and conditionals
