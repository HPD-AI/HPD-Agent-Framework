...
Skills, SubAgents, and collapsed plugins all use **dual-context instructions** to guide the agent:
...
// Collapse instructions - same dual-context
[Collapse(
    description: "Database operations",
    // Auto-generated: "DatabasePlugin expanded. Available functions: Query, Insert, Update, Delete"
