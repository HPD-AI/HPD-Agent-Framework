...
Skills use the same dual-context architecture as collapsed plugins:
...
> **Important:** Like skills, collapsed plugins automatically generate a base expansion message:
> ```
...
FunctionResult: "FilePlugin expanded. Available functions: ReadFile, WriteFile, DeleteFile"
```
...
| Collapse `FunctionResult` | Appended to auto-generated expansion message | Once on expansion | *Additional* context (tips, state) |
| Collapse `SystemPrompt` | System prompt | Every turn while expanded | Critical rules |
