...
/// <summary>
/// Defines a tool that executes on the frontend.
/// Mirrors the structure frontends provide: name, description, parameters (JSON Schema).
/// Tools are always registered inside a <see cref="FrontendPluginDefinition"/> (container).
/// </summary>
