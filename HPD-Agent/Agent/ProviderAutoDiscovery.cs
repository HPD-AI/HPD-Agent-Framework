...
#pragma warning restore CA2255
    ...
    private static void TryInitializeKnownProviders()
    {
        ...
        TryInitializeProviderByTypeName("HPD.Agent.Providers.OpenAI.OpenAIProviderModule, HPD-Agent.Providers.OpenAI");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.Anthropic.AnthropicProviderModule, HPD-Agent.Providers.Anthropic");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.GoogleAI.GoogleAIProviderModule, HPD-Agent.Providers.GoogleAI");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.AzureAIInference.AzureAIInferenceProviderModule, HPD-Agent.Providers.AzureAIInference");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.Bedrock.BedrockProviderModule, HPD-Agent.Providers.Bedrock");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.Ollama.OllamaProviderModule, HPD-Agent.Providers.Ollama");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.Mistral.MistralProviderModule, HPD-Agent.Providers.Mistral");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.HuggingFace.HuggingFaceProviderModule, HPD-Agent.Providers.HuggingFace");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.OnnxRuntime.OnnxRuntimeProviderModule, HPD-Agent.Providers.OnnxRuntime");
        TryInitializeProviderByTypeName("HPD.Agent.Providers.OpenRouter.OpenRouterProviderModule, HPD-Agent.Providers.OpenRouter");
    }
