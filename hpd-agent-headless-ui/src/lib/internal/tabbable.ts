/**
 * Tabbable element detection utilities
 *
 * Wraps the `tabbable` library to provide utilities for finding
 * tabbable and focusable elements in the DOM.
 */
...
// Re-export tabbable library functions
export { isTabbable, isFocusable, tabbable, focusable };
