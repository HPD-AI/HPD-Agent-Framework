...
| Event Type | C# Class | Description |
|------------|----------|-------------|
| `STRUCTURED_RESULT` | `StructuredResultEvent<T>` | Parsed result (may be partial) |
...
| `MODEL_CALL_RETRY` | `ModelCallRetryEvent` | LLM streaming retry — **clear partial UI text when received** |
