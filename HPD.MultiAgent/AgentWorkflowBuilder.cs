...
public class AgentWorkflowBuilder
{
    ...
    /// </summary>
    public AgentWorkflowBuilder(MultiAgentWorkflowConfig config)
    {
        _graphBuilder = new GraphBuilder();
    ...
    /// </summary>
    public AgentWorkflowBuilder WithMaxIterations(int maxIterations)
    {
    ...
    /// </summary>
    public AgentWorkflowBuilder WithTimeout(TimeSpan timeout)
    {
    ...
    /// </summary>
    public static AgentWorkflowBuilder FromConfig(string jsonPath)
    {
        ...
        return new AgentWorkflowBuilder(config);
    }

    /// <summary>
    /// Load workflow from configuration object.
    /// </summary>
    public static AgentWorkflowBuilder FromConfig(MultiAgentWorkflowConfig config)
    {
        return new AgentWorkflowBuilder(config);
    }
...
public static class AgentWorkflow
{
    ...
    /// </summary>
    public static AgentWorkflowBuilder Create() => new();

    /// <summary>
    /// Create a workflow builder from configuration.
    /// </summary>
    public static AgentWorkflowBuilder FromConfig(MultiAgentWorkflowConfig config)
        => AgentWorkflowBuilder.FromConfig(config);

    /// <summary>
    /// Create a workflow builder from JSON file.
    /// </summary>
    public static AgentWorkflowBuilder FromJson(string jsonPath)
        => AgentWorkflowBuilder.FromConfig(jsonPath);
}
