...
See [05.1 Middleware Lifecycle](./04.1%20Middleware%20Lifecycle.md) for complete hook reference.
...
See [05.2 Middleware State](./04.2%20Middleware%20State.md) for full state guide.
...
See [05.2 Middleware State](./04.2%20Middleware%20State.md) for full persistence guide.
...
See [05.3 Middleware Events](./04.3%20Middleware%20Events.md) for full event guide.
...
- [05.2 Middleware State](./04.2%20Middleware%20State.md) - State management patterns
- [05.3 Middleware Events](./04.3%20Middleware%20Events.md) - Event emission and handling
- [05.4 Built-in Middleware](./04.4%20Built-in%20Middleware.md) - Study production examples
