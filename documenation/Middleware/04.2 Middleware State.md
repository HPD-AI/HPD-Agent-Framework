...
**How it works:**
- States marked `Persistent = true` are automatically saved to `Session.MiddlewareState` (session-scoped) or `Branch.MiddlewareState` (branch-scoped, default)
...
await agent.RunAsync(["What's the weather?"], branch);
...
- [05.1 Middleware Lifecycle](./04.1%20Middleware%20Lifecycle.md) - Complete hook reference
- [05.3 Middleware Events](./04.3%20Middleware%20Events.md) - Emit events and wait for responses
- [05.4 Built-in Middleware](./04.4%20Built-in%20Middleware.md) - See state usage in real middleware
- [05.5 Custom Middleware](./04.5%20Custom%20Middleware.md) - Build your own with state
