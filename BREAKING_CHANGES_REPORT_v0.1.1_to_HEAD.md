# Comprehensive Breaking Changes Report: v0.1.4 to HEAD

**Report Generated:** 2026-01-12  
**Comparison Range:** v0.1.4 → HEAD (main branch)  
...
This report documents all breaking changes between version v0.1.4 and the current HEAD. The changes represent a significant architectural evolution with multiple breaking changes across naming conventions, package structure, middleware architecture, event systems, and session management.
...
- `Microsoft.Extensions.AI.Abstractions` updated from 10.0.0 → 10.1.4
- `Microsoft.Extensions.AI` updated from 10.0.0 → 10.1.4
...
```xml
<!-- Updated -->
<PackageReference Include="Microsoft.Extensions.AI.Abstractions" Version="10.1.4" />
<PackageReference Include="Microsoft.Extensions.AI" Version="10.1.4" />
