...
private static bool EvaluateFindFilesCondition(IPluginMetadata? context)
{
    ...
    try
    {
        ...
        return typedMetadata.EnableSearch;  // ← Checks the property!
    }
    catch (Exception ex)
    {
...
public static List<AIFunction> CreateAllFunctions(IPluginMetadata? context)
{
