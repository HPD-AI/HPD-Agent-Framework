...
/// <summary>Writes chunks to an in-process in-memory vector store (testing).</summary>
[GraphNodeHandler(NodeName = "WriteInMemory")]
public sealed partial class InMemoryWriterHandler
{
