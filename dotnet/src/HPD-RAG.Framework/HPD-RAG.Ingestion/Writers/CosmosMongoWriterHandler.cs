...
/// <summary>Writes chunks to an Azure Cosmos DB (MongoDB API) collection.</summary>
[GraphNodeHandler(NodeName = "WriteCosmosMongo")]
public sealed partial class CosmosMongoWriterHandler
{
