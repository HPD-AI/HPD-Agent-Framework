...
/// <summary>Writes chunks to an Azure AI Search index.</summary>
[GraphNodeHandler(NodeName = "WriteAzureAISearch")]
public sealed partial class AzureAISearchWriterHandler
{
