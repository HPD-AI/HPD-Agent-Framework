...
/// <summary>Writes chunks to a SQL Server 2025+ VECTOR collection.</summary>
[GraphNodeHandler(NodeName = "WriteSqlServer")]
public sealed partial class SqlServerWriterHandler
{
