...
/// <summary>Writes chunks to a PostgreSQL (pgvector) collection.</summary>
[GraphNodeHandler(NodeName = "WritePostgres")]
public sealed partial class PostgresWriterHandler
{
